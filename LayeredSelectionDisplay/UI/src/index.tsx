...
import { LayeredSelectionDisplaySectionsComponent } from "mods/LayeredSelectionDisplaySections/LayeredSelectionDisplaySections";
...
const register: ModRegistrar = (moduleRegistry) => {
    ...
    moduleRegistry.extend("game-ui/game/components/tool-options/mouse-tool-options/mouse-tool-options.tsx", 'MouseToolOptions', LayeredSelectionDisplaySectionsComponent);
