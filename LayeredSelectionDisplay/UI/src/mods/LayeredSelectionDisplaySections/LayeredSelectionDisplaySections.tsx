    ...
    (Component: any) => {
        return (props) => {
            ...
            useEffect(() => {
                ...
                // Another tool (or non-game mode) is using this shared container:
                // always restore the vanilla appearance so it isn't stuck minimized.
            ...
            const hidePanelToolTip =
                translate(
                    "LAYERED_SELECTION_DISPLAY_MAINPANEL.HidePanelToolTip",
                    locale[
                        "LAYERED_SELECTION_DISPLAY_MAINPANEL.HidePanelToolTip"
                    ]
                );
            ...
            const showPanelToolTip =
                translate(
                    "LAYERED_SELECTION_DISPLAY_MAINPANEL.ShowPanelToolTip",
                    locale[
                        "LAYERED_SELECTION_DISPLAY_MAINPANEL.ShowPanelToolTip"
                    ]
                );
                            ...
                            <>
                                ...
                                >
                                    ...
                                    <VanillaComponentResolver.instance.ToolButton
                                        ...
                                        tooltip={hidePanelToolTip}
                                        src="coui://uil/Colored/ArrowsMinimizeBold.svg"
                                        className={
                                            VanillaComponentResolver
                                                .instance
                                                .toolButtonTheme.button
            ...
            if (
                ...
                chld.push(
                    <Tooltip
                        key="lsd-minimized-tooltip"
                        tooltip={showPanelToolTip}
                    >
