// <copyright file="ReflectionExtensions.cs" company="0belix's Mods. MIT License">
// Copyright (c) 0belix's Mods. MIT License. All rights reserved.
// </copyright>

namespace LayeredSelectionDisplay.Utils
{
    using System.Reflection;
    using LayeredSelectionDisplay;
    ...
    public static class ReflectionExtensions
    {
        ...
        public static object GetMemberValue(this object obj, string memberName)
        {
            ...
            if (memInf == null)
            {
                LayeredSelectionDisplayMod.Instance.Logger.Error(new System.Exception("memberName"), $"{nameof(ReflectionExtensions)} {nameof(GetMemberInfo)} Couldn't find member name! ");
            }
