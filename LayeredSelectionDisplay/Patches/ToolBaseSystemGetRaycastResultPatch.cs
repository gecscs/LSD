...
namespace LayeredSelectionDisplay.Patches
{
    ...
    public class ToolBaseSystemGetRaycastResultPatch
    {
        ...
        {
            LayeredSelectionDisplayUISystem lsdLayeredSelectionDIsplayUISystem = World.DefaultGameObjectInjectionWorld?.GetOrCreateSystemManaged<LayeredSelectionDisplayUISystem>();
            if (lsdLayeredSelectionDIsplayUISystem.SelectedRaycastTarget != LayeredSelectionDisplayUISystem.RaycastTarget.Vanilla)
            {
                entity = Entity.Null;
                hit = default;
                return true;
            ...
            if (raycastHitSomething
                ...
                && lsdLayeredSelectionDIsplayUISystem.SelectedRaycastTarget == LayeredSelectionDisplayUISystem.RaycastTarget.Lanes)
            {
                entity = Entity.Null;
                hit = default;
                LayeredSelectionDisplayMod.Instance.Logger.Debug($"{nameof(ToolBaseSystemGetRaycastResultPatch)}.{nameof(Prefix)} skipped method.");
                return false;
            }

            if (raycastHitSomething
                && !toolSystem.EntityManager.HasComponent<Deleted>(result.m_Owner)
                && lsdLayeredSelectionDIsplayUISystem.SelectedRaycastTarget == LayeredSelectionDisplayUISystem.RaycastTarget.Vanilla)
            {
                if (((lsdLayeredSelectionDIsplayUISystem.SelectedVanillaFilters & LayeredSelectionDisplayUISystem.VanillaFilters.Buildings) != LayeredSelectionDisplayUISystem.VanillaFilters.Buildings
                    ...
                    || ((lsdLayeredSelectionDIsplayUISystem.SelectedVanillaFilters & LayeredSelectionDisplayUISystem.VanillaFilters.Trees) != LayeredSelectionDisplayUISystem.VanillaFilters.Trees
                    && toolSystem.EntityManager.HasComponent<Game.Objects.Tree>(result.m_Hit.m_HitEntity))
                    || ((lsdLayeredSelectionDIsplayUISystem.SelectedVanillaFilters & LayeredSelectionDisplayUISystem.VanillaFilters.Plants) != LayeredSelectionDisplayUISystem.VanillaFilters.Plants
                    && toolSystem.EntityManager.HasComponent<Game.Objects.Plant>(result.m_Hit.m_HitEntity)
                    && !toolSystem.EntityManager.HasComponent<Game.Objects.Tree>(result.m_Hit.m_HitEntity))
                    || ((lsdLayeredSelectionDIsplayUISystem.SelectedVanillaFilters & LayeredSelectionDisplayUISystem.VanillaFilters.Decals) != LayeredSelectionDisplayUISystem.VanillaFilters.Decals
                ...
                if ((lsdLayeredSelectionDIsplayUISystem.SelectedVanillaFilters & LayeredSelectionDisplayUISystem.VanillaFilters.Props) != LayeredSelectionDisplayUISystem.VanillaFilters.Props &&
