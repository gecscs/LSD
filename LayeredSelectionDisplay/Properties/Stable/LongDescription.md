# LSD — Layered Selection Display
  ...
  **LSD** gives you more control over asset selection in *Cities: Skylines II*, allowing you to filter asset types from the vanilla selection tool and use a dedicated **Marquee Tool** to find and select assets hidden beneath layers of clutter.
  ...
  1. Set the asset type filters according to what you want the vanilla selection tool to be able to select.
  2. Use the vanilla selection tool normally.
  3. Disabled asset types will be ignored when selecting assets.
  
  ### Marquee Tool
  
  1. Open the **Marquee List** panel by clicking the **Marquee Tool** button next to the selection filters.
  2. Click the **Marquee Tool** button at the top of the panel to activate the Marquee Selection Tool.
  3. Draw a marquee around the area containing the assets you want to select. The configured LSD selection filters will be applied.
  4. LSD imports the selected assets into the list.
  5. Hover over an item in the list to highlight the corresponding asset in the game world.
  6. Left Click an item to select the asset and open its Info Panel.
  7. Right Click an item to open the asset inside Extra Details Tool's Transform Tool Gizmo panel if available.
  8. Remove any unwanted assets from the list to keep only the assets you want to work with.
  
  ### Import Move It's Selection
  
  1. Open the **Marquee List** panel by clicking the **Marquee Tool** button next to the selection filters.
  2. Use **Move It's Marquee Selection Tool** to select the area containing the assets you want to work with.
  3. Click the **Refresh** button at the top of the List Panel.
  4. LSD imports Move It's current selection into the list.
  5. Hover over an item in the list to highlight the corresponding asset in the game world.
  6. Click an item to select the asset and open its Info Panel.
  7. Right Click an item to open the asset inside Extra Details Tool's Transform Tool Gizmo panel if available.
  8. Remove any unwanted assets from the list to keep only the assets you want to work with.

  The list remains available until you make a new selection or reload Move It's, so you can continue selecting and manipulating assets from the same group.
  ...
  - **Extra Detailing Tools** - if installed with a version that contains the Transform Tool Gizmo panel, LSD allows the user to open the asset directly on EDT's TT panel by right clicking the asset on the list.
  - **I18n Everywhere**
