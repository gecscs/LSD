...
* Localization - GPT (German), GPT (Chinese Simplified), GPT (Korean), GPT (Russian), GPT (Polish), RocketDragon08 (Spanish), 0belix (French), GPT (Chinese Traditional), GPT (Italian), GPT (Dutch), 0belix (pt-PT), 0belix (pt-BR)