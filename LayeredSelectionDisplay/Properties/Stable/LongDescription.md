# LSD — Layered Selection Display
  ...
  **LSD** gives you more control over asset selection in *Cities: Skylines II*, allowing you to filter asset types from the vanilla selection tool and use a dedicated **Marquee Tool** to find and select assets hidden beneath layers of clutter.
  ...
  Use the Marquee Tool to select an area and collect all relevant assets into a dedicated list.
  ...
  7. Remove any unwanted assets from the list to keep only the assets you want to work with.
  ...
  - **Honu / River-Mochi** — Support, advice, and inspiration from City WatchDog and Hover Colors.
