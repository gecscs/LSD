// <copyright file="SubElementBulldozerTool.cs" company="0belix's Mods. MIT License">
// Copyright (c) 0belix's Mods. MIT License. All rights reserved.
// </copyright>

namespace LSD_Layered_Selection_Display.Tools
{
    using System;
    using System.Linq;
    ...
    public partial class SubElementBulldozerTool : ToolBaseSystem
    {
        ...
        private LSDLayeredSelectionDisplayUISystem m_LSDLayeredSelectionDisplayUISystem;
        ...
        {
            if (m_LSDLayeredSelectionDisplayUISystem.SubElementBulldozeToolActive &&
        ...
        public override void InitializeRaycast()
        {
            ...
            if (m_LSDLayeredSelectionDisplayUISystem.ActiveSelectionMode == LSDLayeredSelectionDisplayUISystem.SelectionMode.Reset)
            {
                ...
                if (m_LSDLayeredSelectionDisplayUISystem.UpgradeIsMain)
                {
            ...
            if (m_RenderingSystem.markersVisible && m_LSDLayeredSelectionDisplayUISystem.SelectedRaycastTarget == LSDLayeredSelectionDisplayUISystem.RaycastTarget.Markers)
            {
                m_ToolRaycastSystem.typeMask = m_LSDLayeredSelectionDisplayUISystem.MarkersFilter;
                if ((m_LSDLayeredSelectionDisplayUISystem.MarkersFilter & TypeMask.Net) == TypeMask.Net)
                {
            ...
            else
            {
                ...
                if (LSDLayeredSelectionDisplayMod.Instance.Settings.AllowRemovingSubElementNetworks)
                {
        ...
        public void RequestDisable()
        {
            ...
            m_LSDLayeredSelectionDisplayUISystem.EnsureToolbarBulldozerClassList();
        }
        ...
        protected override void OnCreate()
        {
            ...
            m_LSDLayeredSelectionDisplayUISystem = World.GetOrCreateSystemManaged<LSDLayeredSelectionDisplayUISystem>();
        ...
        protected override void OnStartRunning()
        {
            ...
            m_LSDLayeredSelectionDisplayUISystem.SubElementBulldozeToolActive = true;
            m_LSDLayeredSelectionDisplayUISystem.EnsureToolbarBulldozerClassList();
        ...
        protected override void OnStopRunning()
        {
            ...
            m_LSDLayeredSelectionDisplayUISystem.SubElementBulldozeToolActive = false;
            m_LSDLayeredSelectionDisplayUISystem.EnsureToolbarBulldozerClassList();
        }
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            if (m_PreviousRaycastedEntity != currentRaycastEntity || !raycastFlag || currentRaycastEntity == Entity.Null || (m_LSDLayeredSelectionDisplayUISystem.ActiveSelectionMode == LSDLayeredSelectionDisplayUISystem.SelectionMode.Reset && !hasCustomBufferFlag))
            {
                EntityManager.AddComponent<BatchesUpdated>(m_HighlightedQuery);
                EntityManager.RemoveComponent<Highlighted>(m_HighlightedQuery);
            ...
            if (!hasExtractorComponentFlag && (!hasExtensionComponentFlag || LSDLayeredSelectionDisplayMod.Instance.Settings.AllowRemovingExtensions) && !hasServiceUpgradeComponentFlag)
            {
                if (m_HighlightedQuery.IsEmptyIgnoreFilter && raycastFlag && hasOwnerComponentFlag && !hasNodeComponentFlag)
                {
                    ...
                    {
                        if (m_LSDLayeredSelectionDisplayUISystem.ActiveSelectionMode == LSDLayeredSelectionDisplayUISystem.SelectionMode.Matching)
                        {
                        ...
                        else if (m_LSDLayeredSelectionDisplayUISystem.ActiveSelectionMode == LSDLayeredSelectionDisplayUISystem.SelectionMode.Similar)
                        {
            ...
            {
                m_WarningTooltipSystem.RemoveTooltip("BulldozeSubelement");
                if (hasExtensionComponentFlag && !LSDLayeredSelectionDisplayMod.Instance.Settings.AllowRemovingExtensions && !hasServiceUpgradeComponentFlag)
                {
            ...
            if (raycastFlag && !hasNodeComponentFlag && hasExtensionComponentFlag && LSDLayeredSelectionDisplayMod.Instance.Settings.AllowRemovingExtensions && !hasServiceUpgradeComponentFlag)
            {
            ...
            if (raycastFlag && !hasNodeComponentFlag && EntityManager.HasComponent<Edge>(currentRaycastEntity) && LSDLayeredSelectionDisplayMod.Instance.Settings.AllowRemovingSubElementNetworks)
            {
            ...
            if (m_LSDLayeredSelectionDisplayUISystem.SelectedRaycastTarget == LSDLayeredSelectionDisplayUISystem.RaycastTarget.Markers && (m_LSDLayeredSelectionDisplayUISystem.MarkersFilter & TypeMask.Net) == TypeMask.Net && !LSDLayeredSelectionDisplayMod.Instance.Settings.AllowRemovingSubElementNetworks)
            {
            ...
            if (EntityManager.TryGetComponent(owner.m_Owner, out PrefabRef prefabRef1) && m_PrefabSystem.TryGetPrefab(prefabRef1.m_Prefab, out PrefabBase prefabBase1) && m_LSDLayeredSelectionDisplayUISystem.ActiveSelectionMode == LSDLayeredSelectionDisplayUISystem.SelectionMode.Single)
            {
            ...
            if (applyAction.WasPressedThisFrame())
            {
                Entity targetEntity = currentRaycastEntity;

                if (targetEntity == Entity.Null && m_MainEntities.Length > 0)
                {
                    targetEntity = m_MainEntities[0];
                }

                // Prefer owner for nodes/extensions, because those usually map better to info panel targets.
                if (targetEntity != Entity.Null &&
                    EntityManager.TryGetComponent(targetEntity, out Owner targetOwner) &&
                    targetOwner.m_Owner != Entity.Null &&
                    (EntityManager.HasComponent<Game.Net.Node>(targetEntity) ||
                     EntityManager.HasComponent<Game.Buildings.Extension>(targetEntity)))
                {
                    targetEntity = targetOwner.m_Owner;
                }

                m_LSDLayeredSelectionDisplayUISystem.RequestFocusEntity(targetEntity);
            }
