// <copyright file="RemoveVehiclesCimsAndAnimalsTool.cs" company="0belix's Mods. MIT License">
...
namespace LSD_Layered_Selection_Display.Tools
{
    ...
    public partial class RemoveVehiclesCimsAndAnimalsTool : ToolBaseSystem
    {
        ...
        {
            if (m_LSDLayeredSelectionDisplayUISystem.VCAToolActive &&
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            float radius = m_LSDLayeredSelectionDisplayUISystem.SelectionRadius;
