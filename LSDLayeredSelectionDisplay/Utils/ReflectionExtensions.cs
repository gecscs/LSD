...
namespace LSD_Layered_Selection_Display.Utils
{
    ...
    public static class ReflectionExtensions
    {
        ...
        public static object GetMemberValue(this object obj, string memberName)
        {
            ...
            if (memInf == null)
            {
                LSDLayeredSelectionDisplayMod.Instance.Logger.Error(new System.Exception("memberName"), $"{nameof(ReflectionExtensions)} {nameof(GetMemberInfo)} Couldn't find member name! ");
            }
