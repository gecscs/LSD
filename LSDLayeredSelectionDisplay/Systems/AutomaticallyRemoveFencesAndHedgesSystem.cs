// <copyright file="AutomaticallyRemoveFencesAndHedgesSystem.cs" company="0belix's Mods. MIT License">
...
namespace LSD_Layered_Selection_Display.Systems
{
    ...
    public partial class AutomaticallyRemoveFencesAndHedges : GameSystemBase
    {
        ...
        protected override void OnGameLoadingComplete(Purpose purpose, GameMode mode)
        {
            ...
            if (mode.IsGame())
            {
                Enabled = LSDLayeredSelectionDisplayMod.Instance.Settings.AutomaticRemovalFencesAndHedges;
            }
            else
            {
                Enabled = false;
            ...
            if (!LSDLayeredSelectionDisplayMod.Instance.Settings.AutomaticRemovalFencesAndHedges)
            {
                return;
            }
