// <copyright file="AutomaticallyRemoveManicuredGrassSurfaceSystem.cs" company="0belix's Mods. MIT License">
...
namespace LSD_Layered_Selection_Display.Systems
{
    ...
    public partial class AutomaticallyRemoveManicuredGrassSurfaceSystem : GameSystemBase
    {
        ...
        protected override void OnGameLoadingComplete(Purpose purpose, GameMode mode)
        {
            ...
            if (mode.IsGame())
            {
                Enabled = LSDLayeredSelectionDisplayMod.Instance.Settings.AutomaticRemovalManicuredGrass;
            }
            else
            {
                Enabled = false;
        ...
        protected override void OnUpdate()
        {
            ...
            foreach (Entity entity in entities)
            {
                ...
                if (m_GrassSurfacePrefabEntities.Contains(currentCreationDefinition.m_Prefab))
                {
