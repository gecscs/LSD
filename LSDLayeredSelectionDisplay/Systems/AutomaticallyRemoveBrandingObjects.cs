// <copyright file="AutomaticallyRemoveBrandingObjects.cs" company="0belix's Mods. MIT License">
...
namespace LSD_Layered_Selection_Display.Systems
{
    ...
    public partial class AutomaticallyRemoveBrandingObjects : GameSystemBase
    {
        ...
        protected override void OnGameLoadingComplete(Purpose purpose, GameMode mode)
        {
            ...
            if (mode.IsGame())
            {
               Enabled = LSDLayeredSelectionDisplayMod.Instance.Settings.AutomaticRemovalBrandingObjects;
            }
            else
            {
                Enabled = false;
            ...
            if (!LSDLayeredSelectionDisplayMod.Instance.Settings.AutomaticRemovalBrandingObjects)
            {
                return;
            }
