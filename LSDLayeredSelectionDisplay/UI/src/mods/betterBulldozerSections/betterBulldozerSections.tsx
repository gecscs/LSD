...
const focusEntityIndex$ = bindValue<number>(mod.id, "FocusEntityIndex");
const focusEntityVersion$ = bindValue<number>(mod.id, "FocusEntityVersion");
const focusEntityNonce$ = bindValue<number>(mod.id, "FocusEntityNonce");
...
export const LSDLayeredSelectionDisplayComponent: ModuleRegistryExtend = (Component : any) => {
    ...
    return (props) => {
        ...
        const focusEntityIndex = useValue(focusEntityIndex$);
        const focusEntityVersion = useValue(focusEntityVersion$);
        const focusEntityNonce = useValue(focusEntityNonce$);
        const entity = { index: focusEntityIndex, version: focusEntityVersion };


        useEffect(() => {
            if (focusEntityIndex >= 0 && focusEntityVersion >= 0) {
                selectedInfo.selectEntity(entity);
                camera.focusEntity(entity);
                // focusEntity({ index: focusEntityIndex, version: focusEntityVersion });
            }
        }, [focusEntityNonce, focusEntityIndex, focusEntityVersion]);
        ...
        const surfacesFilterTooltip =       translate(tooltipDescriptionPrefix + surfacesID,                locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.SurfacesFilterButton"]);
        const spacesFilterTooltip =         translate(tooltipDescriptionPrefix + spacesID,                  locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.SpacesFilterButton"]);
        const staticObjectMarkersTooltip =  translate(tooltipDescriptionPrefix + staticObjectsID,           locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.StaticObjectsFilterButton"]);
        const markerNetworkTooltip =        translate(tooltipDescriptionPrefix + networksFilterID,          locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.NetworksFilterButton"]);
        const gameplayManipulationTooltip = translate(tooltipDescriptionPrefix + gameplayManipulationID,    locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.GameplayManipulationButton"]);
        const bypassConfirmationTooltip =   translate(tooltipDescriptionPrefix + bypassConfirmationID,      locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.BypassConfirmationButton"]);
        const raycastMarkersTooltip =       translate(tooltipDescriptionPrefix + raycastMarkersID,          locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.RaycastMarkersButton"]);
        const raycastAreasTooltip =         translate(tooltipDescriptionPrefix + raycastAreasID,            locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.RaycastAreasButton"]);
        const lanesTooltip =                translate(tooltipDescriptionPrefix + lanesID,                   locale["YY_LSD_LAYERED_SELECTION_DISPLAY_DESCRIPTION.RaycastLanesButton"]);

        const subElementBulldozerDescription = translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[SubElementBulldozerButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[SubElementBulldozerButton]"]);
        const subElementsOfMainElementDescription = translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[SubElementsOfMainElement]", locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[SubElementsOfMainElement]"]);
        const upgradeIsMainDescription = translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[UpgradeIsMain]", locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[UpgradeIsMain]"]);
        ...
        const spacesFilterTitle =           translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[SpacesFilterButton]",locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[SpacesFilterButton]"]);
        const staticObjectsFilterTitle =    translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[StaticObjectsFilterButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[StaticObjectsFilterButton]"]);
        const markerNetworkFilterTitle =    translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[NetworksFilterButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[NetworksFilterButton]"]);
        const gameplayManipulationTitle =   translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[GameplayManipulationButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[GameplayManipulationButton]"]);
        const bypassConfirmationTitle =     translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[BypassConfirmationButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[BypassConfirmationButton]"]);
        const raycastMarkersTitle =         translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[RaycastMarkersButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[RaycastMarkersButton]"]);
        const raycastAreasTitle =           translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[RaycastAreasButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[RaycastAreasButton]"]);
        const lanesTitle =                  translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[RaycastLanesButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[RaycastLanesButton]"]);
        const subElementBulldozerTitle =    translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[SubElementBulldozerButton]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[SubElementBulldozerButton]"]);
        const subElementsofMainElementTitle =   translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[SubElementsOfMainElement]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[SubElementsOfMainElement]"]);
        const upgradeIsMainTitle =              translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[UpgradeIsMain]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[UpgradeIsMain]"]);
        const singleTooltipTitle =          translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[Single]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[Single]"]);
        const singleTooltipDescription =          translate( "LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[Single]",locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[Single]"]);
        const matchingTooltipTitle =        translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[Matching]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[Matching]"]);
        const matchingTooltipDescription = translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[Matching]", locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[Matching]"]);
        const similarTooltipTitle =         translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[Similar]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[Similar]"]);
        const similarTooltipDescription =   translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[Similar]", locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[Similar]"]);
        const resetTooltipTitle =           translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[Reset]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[Reset]"]);
        const resetTooltipDescription =     translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[Reset]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[Reset]"]);
        const singleOrDragTooltipTitle =    translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[SingleMovingObject]" , locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[SingleMovingObject]"]);
        const singleOrDragTooltipDescription = translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[SingleMovingObject]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[SingleMovingObject]"]);
        const radiusSelectionTooltipTitle =     translate("LSDLayeredSelectionDisplay.TOOLTIP_TITLE[RadiusSelection]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_TITLE[RadiusSelection]"]);
        const radiusSelectionTooltipDescription = translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[RadiusSelection]" ,locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[RadiusSelection]"]);
        const increaseRadiusDescription = translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[IncreaseRadius]" , locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[IncreaseRadius]"]);
        const decreaseRadiusDescription = translate("LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[DecreaseRadius]", locale["LSDLayeredSelectionDisplay.TOOLTIP_DESCRIPTION[DecreaseRadius]"]);
            ...
            result.props.children?.push(
               ...
               <>
                    ...
                    { subElementBulldozerToolActive && (
                        ...
                        <>
                            <VanillaComponentResolver.instance.Section title={translate("LSDLayeredSelectionDisplay.SECTION_TITLE[Selection]" ,locale["LSDLayeredSelectionDisplay.SECTION_TITLE[Selection]"])}>
                            ...
                            <VanillaComponentResolver.instance.Section title={translate("LSDLayeredSelectionDisplay.SECTION_TITLE[Tier]", locale["LSDLayeredSelectionDisplay.SECTION_TITLE[Tier]"])}>
                    ...
                    { raycastTarget == 4 && (
                        ...
                        <>
                            ...
                            <VanillaComponentResolver.instance.Section title={translate("LSDLayeredSelectionDisplay.SECTION_TITLE[Radius]",locale["LSDLayeredSelectionDisplay.SECTION_TITLE[Radius]"])}>
